...
public partial class EmployeesPage : ContentPage
{
    ...
    private void LoadEmployees()
    {
        ...
        try
        {
            ...
            {
                BaseAddress = new Uri(DeviceInfo.Platform == DevicePlatform.Android ? "http://10.0.2.2:5099" : "http://localhost:5090")
            };
    ...
    private async void EmployeeMenuItem_Clicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            client.BaseAddress = new Uri(DeviceInfo.Platform == DevicePlatform.Android ? "http://10.0.2.2:5099" : "http://localhost:5099");
